...
**trap_file_deployment.py** deploys a hidden file, `.aa.pdf`, to a pre-defined list of directories. This list can be adjusted acording to the deployment requirements. The trap files are 4096 bytes in size.

**canarywatch.py** does the heavy lifiting by monitoring for any activity on the deployed trap files then killing the offending process.
